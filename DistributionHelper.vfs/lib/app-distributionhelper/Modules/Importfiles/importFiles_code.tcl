...
proc Disthelper_Code::readFile {filename} {
    ...
    foreach line $GL_file(Header) {
        ...
        if { [lsearch -nocase $header(shipvia) $line1] != -1} {
            ...
            Disthelper_Helper::detectData .container.frame2.frame2d.shipmentShipViaEntry .container.frame2.frame2d.shipmentShipViaField shipVia
...
proc Disthelper_Code::writeOutPut {} {
    ...
    #
    # CHILDREN
    #   Disthelper_Code::processAddresses
    #
    # PARENTS
        ...
        foreach name [array names importFile] {
            ...
            switch -- $name {
                ...
                02_Company {
                        ...
                        #set Company [Disthelper_Code::processAddresses Company $Company]
                        #puts "Cleansed: $Company [string length $Company]"
                        set $name [Disthelper_Code::processAddresses Company $02_Company]
                }
                03_Attention {
                        ...
                        set $name [Disthelper_Code::processAddresses Attention $03_Attention]
                }
                04_delAddr {
                        #'debug delAddr/$name
                        if {([lindex $l_line $importFile($name)] != "") && ([lindex $l_line $importFile($name)] != " ")} {
                ...
                07_City {
                        ...
                        set $name [Disthelper_Code::processAddresses City $07_City]
                }
                08_State {
                        #'debug State/$name
                        if {([lindex $l_line $importFile($name)] != "") && ([lindex $l_line $importFile($name)] != " ")} {
                ...
                09_Zip {
                        ...
                        set $name [Disthelper_Code::processAddresses Zip $09_Zip]
                }
                10_Country {
                        #'debug Country/$name
                        if {([lindex $l_line $importFile($name)] != "") && ([lindex $l_line $importFile($name)] != " ")} {
                ...
                11_Phone {
                        ...
                        set $name [Disthelper_Code::processAddresses Phone $11_Phone]
                }
                12_Zip     {
