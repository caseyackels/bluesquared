...
proc Disthelper_Preferences::prefGUI {} {
    ...
    tablelist::tablelist $tab2b.listbox \
                ...
                -showseparators yes \
                -fullseparators yes \
                -editstartcommand {Disthelper_Preferences::startCmd} \
                -editendcommand {Disthelper_Preferences::endCmd} \
    ...
    ttk::checkbutton $tab6_left.itemDescCheck -text [mc "Use Default"] -variable international(itemDesc,check) \
                                                                        -command "Disthelper_Helper::setIntlVarDefault itemDesc,check $tab6_left.itemDescEntry"
    ...
    ttk::checkbutton $tab6_left.itemNumCheck -text [mc "Use Default"] -variable international(itemNum,check) \
                                                                        -command "Disthelper_Helper::setIntlVarDefault itemNum,check $tab6_left.itemNumEntry"
    ...
    ttk::checkbutton $tab6_left.itemQtyCheck -text [mc "Use Default"] -variable international(itemQty,check) \
                                                                        -command "Disthelper_Helper::setIntlVarDefault itemQty,check $tab6_left.itemQtyEntry"
    ...
    ttk::checkbutton $tab6_right.licenseDateCheck -text [mc "Use Default"] -variable international(licenseDate,check) \
                                                                        -command "Disthelper_Helper::setIntlVarDefault licenseDate,check $tab6_right.licenseDateEntry"
    ...
    ttk::checkbutton $tab6_right.itemWeightCheck -text [mc "Use Default"] -variable international(itemWeight,check) \
                                                                        -command "Disthelper_Helper::setIntlVarDefault itemWeight,check $tab6_right.itemWeightEntry"
