...
proc Disthelper_Preferences::startCmd {tbl row col text} { 
    #****f* startCmd/Disthelper_Preferences
    # AUTHOR
    #	Casey Ackels
    #
    # COPYRIGHT
...
proc Disthelper_Preferences::endCmd {tbl row col text} { 
    #****f* endCmd/Disthelper_Preferences
    # AUTHOR
    #	Casey Ackels
    #
    # COPYRIGHT
