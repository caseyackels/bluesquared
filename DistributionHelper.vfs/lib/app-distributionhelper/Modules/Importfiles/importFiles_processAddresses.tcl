...
proc Disthelper_Code::processAddresses {name args} {
    #****f* processAddresses/Disthelper_Code
    # AUTHOR
    #	Casey Ackels
    #
    # COPYRIGHT
    ...
    switch -- [lindex $name] {
        Company {
            set addrItem [Disthelper_Code::StringLength $args]
        ...
        delAddr {
            # Addresses must be specially handled, see [Disthelper_Code::cleanse]
            set returnItem [Disthelper_Code::cleanse $args]
           return $returnItem
        }
        delAddr2    {}
        delAddr3    {}
        ...
        State       {
            # Should send this to a StateCleanser to guard against state names spelled out, and extra spaces (ie "CA ")
            #set newState [join $args ""]
        }
        Country     {}
        Phone       {
            set addrItem [Disthelper_Code::CleansePhone $args]
        }
        Zip         {
            set newZip [join [split $args -] ""]
            set newZip [Disthelper_Code::ListToString [join [split $newZip " "] ""]] ;# Get rid of any spaces (notably canadian zips)
...
proc Disthelper_Code::CleansePhone {args} {
    ...
    set newPhone [Disthelper_Code::ListToString $newPhone]
...
proc Disthelper_Code::ListToString {args} {
    #****f* ListToString/Disthelper_Code
    # AUTHOR
    #	Casey Ackels
    #
    # COPYRIGHT
...
proc Disthelper_Code::StringLength {args} {
    #****f* StringLength/Disthelper_Code
    # AUTHOR
    #	Casey Ackels
    #
    # COPYRIGHT
    ...
    set args [Disthelper_Code::ListToString $args]
...
proc Disthelper_Code::cleanse {args} {
    #****f* cleanse/Disthelper_Code
    # AUTHOR
    #	Casey Ackels
    #
    # COPYRIGHT
    ...
    set args [Disthelper_Code::ListToString $args]
    set addr [Disthelper_Code::StringLength $args]
    
    
    if {[lindex $addr 0] eq "fail"} {
        #puts "***FAILED***: $addr"
        set addr1 [Disthelper_Code::ListToString [lindex $addr 1]]
        #puts "*** $addr1"
        ...
        #Error_Message::errorMsg deladdress1 [Disthelper_Code::ListToString [lindex $addr 1]]
    } else {
...
proc Disthelper_Code::international {country pieceweight date boxqty} {
    #****f* international/Disthelper_Code
    # AUTHOR
    #	Casey Ackels
    #
    # COPYRIGHT
