...
namespace eval Cawt {
    ...
    proc GetPkgVersion { pkgName } {
        ...
        # pkgName - The name of the sub-package
        #
        # Returns the version of the sub-package as a string.
    ...
    proc IsComObject { comObj } {
        ...
        #
        # Returns true, if comObj is a valid object.
        # Otherwise returns false.
        #
    ...
    proc GetProgramByExtension { extension } {
        ...
        #
        # Return the path to the program which is associated in the Windows registry
